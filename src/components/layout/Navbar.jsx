...
import { IoChevronBack, IoMenu, IoSearch, IoClose } from 'react-icons/io5'
          ...
          <div className='flex-1 p-6 overflow-y-auto'>
            ...
            <div className='flex flex-col'>
              {history.map((item, index) => (
                <div key={index} className='flex justify-between items-center py-4 border-b border-gray-800/50'>
                  <span 
